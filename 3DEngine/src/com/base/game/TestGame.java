...
public class TestGame extends Game
{
	public void init()
	{
		...
		addObject(
				new GameObject().addComponent(new FreeLook(0.2f)).addComponent(new FreeMove(10.0f)).addComponent(new PointLight(new Vector3f(1,1,1), 0.4f,
						new Attenuation(0,0,0.1f))).addComponent(new Camera((float) Math.toRadians(70.0f), (float) Window.getWidth() / (float) Window.getHeight(), 0.01f, 1000.0f)));
