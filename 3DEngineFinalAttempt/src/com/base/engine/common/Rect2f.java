...
public class Rect2f {
	...
	public Line2f getEdge(int index) {
		if (index == 0)
			return new Line2f(getMaxX(), getMinY(), getMaxX(), getMaxY());
		if (index == 1)
			return new Line2f(getMinX(), getMinY(), getMaxX(), getMinY());
		if (index == 2)
			return new Line2f(getMinX(), getMinY(), getMinX(), getMaxY());
		return new Line2f(getMinX(), getMaxY(), getMaxX(), getMaxY());
	}
