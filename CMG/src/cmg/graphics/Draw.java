...
public class Draw {
	...
	public static void drawTriangle(Vector v1, Vector v2, Vector v3) {
		g.drawPolygon(
			new int[] {dx(v1.x), dx(v2.x), dx(v3.x)},
			new int[] {dx(v1.y), dx(v2.y), dx(v3.y)},
		3);
	}
	
	public static void fillTriangle(Vector v1, Vector v2, Vector v3) {
		g.fillPolygon(
			new int[] {dx(v1.x), dx(v2.x), dx(v3.x)},
			new int[] {dx(v1.y), dx(v2.y), dx(v3.y)},
		3);
