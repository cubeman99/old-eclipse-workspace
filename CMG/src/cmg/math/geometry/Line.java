...
public class Line {
	...
	public Line plus(Vector v) {
		return new Line(this).add(v);
	}
	
	public Line minus(Vector v) {
		return new Line(this).sub(v);
	}
	...
	public Line add(Vector v) {
		end1.add(v);
		end2.add(v);
		return this;
	}
	
	public Line sub(Vector v) {
		end1.sub(v);
		end2.sub(v);
		return this;
	}
