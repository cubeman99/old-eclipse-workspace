...
public class Line3 {
	...
	public Line3(Vector end1, Vector end2) {
	...
	public Vector getCenter() {
		return end1.plus(end2).scaledByInv(2);
	}
	...
	public Line3 plus(Vector v) {
		return new Line3(this).add(v);
	}
	
	public Line3 minus(Vector v) {
		return new Line3(this).sub(v);
	}
	...
	public Vector getPoint(double ratio) {
		return end1.plus(getVector().setLength(length() * ratio));
	}
	...
	public Vector getClosestPoint(Vector point) {
		...
		return end1.plus(fromVector.projectionOn(lineVector));
	}
	...
	public Line3 set(Vector end1, Vector end2) {
		this.end1 = new Vector(end1);
		this.end2 = new Vector(end2);
		return this;
	}
	...
	public Line3 add(Vector v) {
		end1.add(v);
		end2.add(v);
		return this;
	}
	
	public Line3 sub(Vector v) {
		end1.sub(v);
		end2.sub(v);
		return this;
	}
	...
	public Line3 scale(double amount) {
	...
	public static Vector intersection(Line3 l1, Line3 l2) {
		if (l1.isHorizontal()) {
			if (l2.isHorizontal())
				return null;
			if (l2.isVertical()) {
			...
			return Line3.intersection(l2, l1);
	...
	public static Vector intersectionEndless(Line3 l1, Line3 l2) {
		if (l1.isHorizontal()) {
			if (l2.isHorizontal())
			...
			return new Vector(l1.end1.x, yi);
				...
				return Line3.intersectionEndless(l2, l1);
