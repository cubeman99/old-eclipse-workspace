...
public class Quaternion
{
	...
	public Quaternion(Vector3 axis, float angle)
	{
		...
		this.x = (float) (axis.x * sinHalfAngle);
		this.y = (float) (axis.y * sinHalfAngle);
		this.z = (float) (axis.z * sinHalfAngle);
		this.w = cosHalfAngle;
	}
	...
	public Quaternion times(Quaternion r) {
	...
	public Quaternion times(Vector3 r) {
	...
	public Quaternion nlerp(Quaternion dest, float lerpFactor, boolean shortest)
	{
		...
		return correctedDest.minus(this).times(lerpFactor).plus(this).normalized();
	}
	...
	public Quaternion slerp(Quaternion dest, float lerpFactor, boolean shortest)
	{
		...
		return this.times(srcFactor).plus(correctedDest.times(destFactor));
	}
