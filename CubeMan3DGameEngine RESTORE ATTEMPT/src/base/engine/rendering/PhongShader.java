...
public class PhongShader extends Shader {
	...
	private static DirectionalLight directionalLight;// = new DirectionalLight(ambientLight, 0);
	...
	public PhongShader() {
		...
		directionalLight = new DirectionalLight(ambientLight, 0);
		new Entity().addComponent(directionalLight);
