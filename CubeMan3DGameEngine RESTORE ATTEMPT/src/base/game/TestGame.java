...
import base.engine.rendering.BasicShader;
import base.engine.rendering.Material;
import base.engine.rendering.Mesh;
import base.engine.rendering.PhongShader;
...
public class TestGame extends Game {
    ...
    public void initialize() {
    	...
    	mesh    = createInvertedBoxMesh();
    	
    	material = new Material();
    	material.setTexture(ResourceLoader.loadTexture("bricks2.jpg"));
    	material.setNormalMap(ResourceLoader.loadTexture("default_normal.jpg"));
    	material.setDispMap(ResourceLoader.loadTexture("default_disp.png"));
    	material.setColor(new Vector3(1, 1, 1));
    	material.setSpecularIntensity(0.1f);
    	material.setSpecularPower(2);
    	material.setDispMapScale(0.0f);
    	material.setDispMapBias(0.1f);
    	
    	model = new Entity().addComponent(new Model(mesh, material));
//    	model2 = new Entity().addComponent(new Model(mesh, material));
...
//		pointLight.getTransform().setTranslation(new Vector3(0, 3, 0));
    ...
    private Mesh createBoxMesh() {
    	...
    	Mesh m = new Mesh();
    	m.addVertices(vertices, indices, true, true);
    	return m;
    }
...
//    	model2.getTransform().setScalation(0.5f, 0.5f, 0.5f);
    	...
    	transform.setScalation(new Vector3(4, 4, 4));
