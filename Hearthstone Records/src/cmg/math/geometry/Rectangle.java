...
public class Rectangle {
	...
	public double getMinX() {
		return (size.x < 0 ? corner.x + size.x : corner.x);
	}
	
	public double getMinY() {
		return (size.y < 0 ? corner.y + size.y : corner.y);
	}
	...
	public Vector getPoint(double xScale, double yScale) {
		return corner.plus(size.x * xScale, size.y * yScale);
	}
	
	public Rectangle createSubScaleRect(double x, double y, double width, double height) {
