...
public class Settings {
	...
	public static final int MSG_PLAYER_JOIN   = 1; // name, team_index, col_rgb
	public static final int MSG_PLAYER_UPDATE = 2; // pos_x, pos_y, vel_x, vel_y
	
	public static final int MSG_ADD_PLAYER    = 3; // id, name, team_index, col_rgb
	public static final int MSG_REMOVE_PLAYER = 4; // id
	public static final int MSG_GAME_UPDATE   = 5; // ballx, bally, [player_id, playerx, playery] [] []...
