...
public class InputHandler {
	...
	public InputHandler(Keys keys) {
		...
		mapKey(KeyEvent.VK_UP, keys.flipL);
		mapKey(KeyEvent.VK_W, keys.flipL);
		
		mapKey(KeyEvent.VK_Z, keys.flipL);
		mapKey(KeyEvent.VK_X, keys.flipR);
		mapKey(KeyEvent.VK_Q, keys.flipL);
		mapKey(KeyEvent.VK_E, keys.flipR);
		mapKey(KeyEvent.VK_K, keys.flipL);
		mapKey(KeyEvent.VK_L, keys.flipR);
		
		mapKey(KeyEvent.VK_SPACE, keys.instant);

		mapKey(KeyEvent.VK_R, keys.restart);
		mapKey(KeyEvent.VK_ESCAPE, keys.escape);
	}
