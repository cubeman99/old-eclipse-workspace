...
public class GMath {
	...
	public static final Point[] DIRECTION_POINTS   = {new Point(1, 0), new Point(0, -1), new Point(-1, 0), new Point(0, 1)};
	public static final Vector[] DIRECTION_VECTORS = {new Vector(1, 0), new Vector(0, -1), new Vector(-1, 0), new Vector(0, 1)};
