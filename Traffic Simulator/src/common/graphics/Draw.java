...
public class Draw {
	...
	public static void drawRect(Rectangle r) {
		drawRect(r.getX1(), r.getY1(), GMath.abs(r.getWidth()), GMath.abs(r.getHeight()));
	}
	...
	public static void fillRect(Rectangle r) {
		fillRect(r.getX1(), r.getY1(), GMath.abs(r.getWidth()), GMath.abs(r.getHeight()));
	}
