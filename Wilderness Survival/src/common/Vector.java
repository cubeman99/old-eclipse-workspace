...
public class Vector {
	...
	/** Construct a vector at the origin (0, 0). **/
	public Vector() {
		this(0, 0);
	}
	
	/** Construct a vector as a copy of another vector. **/
	public Vector(Vector v) {
		this(v.x, v.y);
	}

	/** Construct a vector as the displacement between two vectors. **/
