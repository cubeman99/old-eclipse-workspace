...
public class EmberSeed extends Seed {
	...
	/** Constructs the default ember seed. */
	public EmberSeed() {
		super();
	}
	/** Constructs a ember seed with the given direction and position. */
	public EmberSeed(int direction, int seedState, Vector point, double z) {
		super("ember_seeds", direction, seedState, new Point(0, 15), point, z);
	}
	...
	public void startEffect() {
		effectSprite.setAnimation(Library.animations.emberSeedEffect);
