...
public class Vector {
	...
	/**
	 * Constructs a vector positioned at the (0, 0).
	 */
	public Vector() {
		this.x = 0.0;
		this.y = 0.0;
	 ...
	 * @param	polar - Set to true to use polar coordinates, otherwise x/y
	 ...
	 * @return	Returns a string representing the vector's x and y values.
	 */
	 ...
	 * Returns false if the specified object is null or not a vector.
	...
	/**
	 * Converts the vector into a point and returns that.
	 * @return	Returns a point representing the vector.
	 */
	...
	/**
	 * Multiplies the vector by the scale.
	 * 
	 * @param	scale - The scale to multiply the vector by.
