...
public class Draw {
	 ...
	 * @param	y - The y coordinate to draw the text at.
	 */
	public static void drawRasterString(Graphics2D g, RasterFont font, String text, double x, double y) {
		drawRasterString(g, font, text, new Vector(x, y), 0);
	}
	/**
	 * Draws the specified text to the graphics object.
	 * 
	 ...
	 * @param	alignment - The alignment settings to use.
	 */
	public static void drawRasterString(Graphics2D g, RasterFont font, String text, double x, double y, int alignment) {
		drawRasterString(g, font, text, new Vector(x, y), alignment);
	}
	/**
	 * Draws the specified text to the graphics object.
	 * 
	 ...
	 * @param	point - The point to draw the text at.
	 */
	public static void drawRasterString(Graphics2D g, RasterFont font, String text, Vector point) {
		drawRasterString(g, font, text, point, 0);
	}
	/**
	 * Draws the specified text to the graphics object.
	 * 
	 ...
	 * @param	alignment - The alignment settings to use.
	 */
	public static void drawRasterString(Graphics2D g, RasterFont font, String text, Vector point, int alignment) {
		...
		int spacing = font.getTileSize().x + font.getCharacterSpacing().x;
		for (int i = 0; i < text.length(); i++) {
			Point index = font.getCharacterIndex(text.charAt(i));
			
			drawTile(g, font, index, point.plus(i * spacing, 0));
		}
	}
	/**
	 * Draws the specified wrapped text to the graphics object.
	 ...
	 * @param	separation - The space between each line.
	 */
	public static void drawRasterStringWrap(Graphics2D g, RasterFont font, String text, double x, double y, double width,
			int maxLines, double separation) {
		drawRasterStringWrap(g, font, text, new Vector(x, y), 0, width, maxLines, separation);
	}
	/**
	 * Draws the specified wrapped text to the graphics object.
	 * 
	 ...
	 * @param	separation - The space between each line.
	 */
	public static void drawRasterStringWrap(Graphics2D g, RasterFont font, String text, double x, double y, int alignment,
			double width, int maxLines, double separation) {
		drawRasterStringWrap(g, font, text, new Vector(x, y), alignment, width, maxLines, separation);
	}
	/**
	 * Draws the specified wrapped text to the graphics object.
	 * 
	 ...
	 * @param	separation - The space between each line.
	 */
	public static void drawRasterStringWrap(Graphics2D g, RasterFont font, String text, Vector point,
			double width, int maxLines, double separation) {
		drawRasterStringWrap(g, font, text, point, 0, width, maxLines, separation);
	}
	/**
	 * Draws the specified wrapped text to the graphics object.
	 * 
	 ...
	 * @param	separation - The space between each line.
	 */
	public static void drawRasterStringWrap(Graphics2D g, RasterFont font, String text, Vector point, int alignment,
			double width, int maxLines, double separation) {
		
		String[] lines = getWrappedString(text, g.getFont(), width, maxLines);
		
		for (int i = 0; i < lines.length; i++) {
			drawRasterString(g, font, lines[i], (float)point.x, (float)(point.y + i * (getStringSize("", g.getFont()).y + separation)), alignment);
		}
	}
	...
	/**
	 * Draws the specified tile to the graphics object.
	 * 
	 * @param	g - The graphics object to draw to.
	 * @param	tileset - The tile set to get the tile from.
	 ...
	 */
	public static void drawTile(Graphics2D g, Tileset tileset, int indexX, int indexY, double x, double y) {
		Point tilePoint = tileset.getTilePoint(indexX, indexY);
		Point tileSize = tileset.getTileSize();
		drawImage(g, tileset.getImage(), x, y, tilePoint.x, tilePoint.y, tileSize.x, tileSize.y);
	}
	/**
	 * Draws the specified tile to the graphics object.
	 * 
	 ...
	 * @param	point - The point to draw the tile at.
	 */
	public static void drawTile(Graphics2D g, Tileset tileset, Point index, Vector point) {
		Point tilePoint = tileset.getTilePoint(index);
		Point tileSize = tileset.getTileSize();
		drawImage(g, tileset.getImage(), point, tilePoint.getVector(), tileSize.getVector());
	}
	...
	public static void drawImage(Graphics2D g, Image image, double x, double y,
		...
		drawImage(g, image, new Vector(x, y), new Vector(srcX, srcY), new Vector(srcW, srcH));
	}
	/**
	 * Draws the specified image to the graphics object.
	 * 
	...
	public static void drawImage(Graphics2D g, Image image, double x, double y, double w, double h,
			double srcX, double srcY, double srcW, double srcH) {
		drawImage(g, image, new Vector(x, y), new Vector(w, h), new Vector(srcX, srcY), new Vector(srcW, srcH));
	}
	/**
	 * Draws the specified image to the graphics object.
	 * 
	 ...
	 * @param	size - The scaled size of the image.
	 */
	public static void drawImage(Graphics2D g, Image image, Vector point, Vector srcPoint, Vector srcSize) {
		if (image != null) {
			g.drawImage(image, (int)point.x, (int)point.y, (int)(point.x + srcSize.x), (int)(point.y + srcSize.y),
					(int)srcPoint.x, (int)srcPoint.y, (int)(srcPoint.x + srcSize.x), (int)(srcPoint.y + srcSize.y), null);
		}
	}
	/**
	 * Draws the specified image to the graphics object.
	 ...
	 * @param	size - The scaled size of the image.
	 */
	public static void drawImage(Graphics2D g, Image image, Vector point, Vector size, Vector srcPoint, Vector srcSize) {
		if (image != null) {
			g.drawImage(image, (int)point.x, (int)point.y, (int)(point.x + size.x), (int)(point.y + size.y),
					(int)srcPoint.x, (int)srcPoint.y, (int)(srcPoint.x + srcSize.x), (int)(srcPoint.y + srcSize.y), null);
		}
	}
	/**
