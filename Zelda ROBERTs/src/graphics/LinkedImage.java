...
public class LinkedImage {
	 ...
	 */
	public LinkedImage(String name) {
	...
	/**
	 * Gets the index of the pixel on the image.
	 * 
	 * @return	Returns the index of the pixel.
	 */
	public int getPixelIndex(Point pixel) {
		return (pixel.x + pixel.y * getWidth());
	}
}
