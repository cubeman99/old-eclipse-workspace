 ...
 */
public class EmberSeeds extends Ammo {

	// ======================= Members ========================
	
	// ===================== Constructors =====================
	
	/** Constructs the default ember seed ammunition. */
	public EmberSeeds() {
		super("ember_seeds", 20);
	}
	...
	public void draw(Graphics2D g, Vector point) {
		Draw.drawTile(g, GamePanel.hudTileset, new Point(1, 2), point.plus(4, 4));
