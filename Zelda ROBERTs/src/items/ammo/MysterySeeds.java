 ...
 */
public class MysterySeeds extends Ammo {

	// ======================= Members ========================
	
	// ===================== Constructors =====================
	
	/** Constructs the default mystery seed ammunition. */
	public MysterySeeds() {
		super("mystery_seeds", 20);
	}
	...
	public void draw(Graphics2D g, Vector point) {
		Draw.drawTile(g, GamePanel.hudTileset, new Point(5, 2), point.plus(4, 4));
	...
	public String getName() {
		return "Mystery Seeds";
	}
	/** Gets the description of the item. */
	public String getDescription() {
		return "A producer of unknown effects.";
	}
