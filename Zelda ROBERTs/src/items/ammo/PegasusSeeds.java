 ...
 */
public class PegasusSeeds extends Ammo {

	// ======================= Members ========================
	
	// ===================== Constructors =====================
	
	/** Constructs the default pegasus seed ammunition. */
	public PegasusSeeds() {
		super("pegasus_seeds", 20);
	}
	...
	public void draw(Graphics2D g, Vector point) {
		Draw.drawTile(g, GamePanel.hudTileset, new Point(3, 2), point.plus(4, 4));
