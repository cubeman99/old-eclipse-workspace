 ...
 */
public class ScentSeeds extends Ammo {

	// ======================= Members ========================
	
	// ===================== Constructors =====================
	
	/** Constructs the default scent seed ammunition. */
	public ScentSeeds() {
		super("scent_seeds", 20);
	}
	...
	public void draw(Graphics2D g, Vector point) {
		Draw.drawTile(g, GamePanel.hudTileset, new Point(2, 2), point.plus(4, 4));
