...
public class Keyboard implements KeyListener {
	...
	public static final Key a = new Key(KeyEvent.VK_Z);
	public static final Key b = new Key(KeyEvent.VK_X);
	public static final Key start = new Key(KeyEvent.VK_ENTER);
	public static final Key select = new Key(KeyEvent.VK_SHIFT);
	public static final Key action = new Key(KeyEvent.VK_Z, KeyEvent.VK_X);
	public static final Key[] arrows = {right, up, left, down};
	public static final Key[] actions = {a, b};
	public static final Key anyKey = new Key(
			KeyEvent.VK_ENTER, KeyEvent.VK_SHIFT, KeyEvent.VK_Z, KeyEvent.VK_X,
	...
	public static Key printScreen = new Key(KeyEvent.VK_PRINTSCREEN);
